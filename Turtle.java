...
public final class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
     ...
     * This method is run in two separate threads, one for rendering and one for listening.
     *
     ...
     * It also regulates the frame rate of the program by sleeping for a calculated amount of time each loop.
     */
     ...
     * It renders the turtles according to the refresh mode and regulates the frame rate of the program
     ...
     * @return true after the time has passed, false if the time has already passed when the method is called
     */
    ...
    /**
     * Initializes the color map with the 147 HTML color names and their corresponding RGB values.
     */
     ...
     * <p>
        ...
        * {@link http://www.w3.org/TR/css3-color/#svg-color|W3C CSS Color Module Level 3} for more information on supported color names.
     * </p>
    ...
    /**
     * Sets up the buffering system.  This is called automatically when the first turtle is created.
     */
 ...
 */
   ...
   /**
     ...
     * @return true if the method was successfully linked to the key, false if the method doesn't exist or has the wrong signature.
     */
    @SuppressWarnings("unchecked")
     ...
     * Simply pass in the name of a method inside of the class that's calling this method. 
     * The method must either take in a Turtle object or a String as a parameter and should return void
     * </p>
     *
     * @param methodName method to be executed when the key is pressed
     * @param keyText key that triggers the method
